...
import chatbox_icon from '../public/icon.png'
import send_icon from '../public/send.png'
import chatbox from '../public/chatbot.jpg'
  ...
  return (
    <>
      <div className='chatbox-icon-container' onClick={handleShowChatBox}>
        <Image src={chatbox_icon} alt='Icon' className='chatbox-icon' />
      </div>
        ...
        <div className='messages'>
          ...
          {isLoading && (
            <div className='typing-box'>
              <Avatar width='3rem' alignSelf='flex-start' margin='0 1rem 0 0' image={chatbox} />
              <Typing />
            </div>
          )}
          {typingMessage && (
            <div className='message-wrapper'>
              <Avatar width='3rem' alignSelf='flex-start' margin='1rem 0 0 0' image={chatbox} />
        ...
        <div className='chatbox-input'>
          <div className='chat-footer'>
            ...
            <button onClick={sendMessage} className='chat-btn'>
              <Image src={send_icon} alt='Icon' className='send-icon' />
            </button>
          </div>
        </div>
      </div>
